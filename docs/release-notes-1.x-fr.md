...
- **Chaque ligne du journal dit de quelle page elle vient.** Il indiquait quel sélecteur avait échoué et quand, jamais où : devant quatre lignes horodatées à la même seconde, rien ne permettait de savoir si elles venaient d'une seule page ou de quatre. Chaque ligne commence désormais par une marque de six caractères — même marque, même page —, et un clic dessus ouvre l'adresse exacte relevée dans un nouvel onglet. Cette adresse reste sur votre appareil : lorsque vous avez autorisé la télémétrie, celle-ci ne transmet toujours que le nom du sélecteur. Les lignes déjà présentes avant cette mise à jour, elles, n'ont pas d'adresse — elle n'était pas enregistrée — et portent une marque neutre jusqu'à ce que leur sélecteur échoue de nouveau, ou que vous effaciez le journal.
