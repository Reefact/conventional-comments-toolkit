...
- **L'onglet d'où vous venez n'attend plus un rechargement.** Autoriser un domaine depuis la page d'options le laissait inerte — précisément celui que vous alliez utiliser. L'extension y devient maintenant active immédiatement.
