...
const errorDiags = () => validate({ body: 'pas de label', platform: { id: 'github', suggestionInfoString: null, slashPrefixes: [] }, isSystemGenerated: false, zone: 'thread-root', canCarryBlockingState: true }, defaultConfig());
    ...
    input.diagnostics = validate(
      {
        ...
        platform: { id: 'github', suggestionInfoString: null, slashPrefixes: [] },
