...
- `CA-46` **Épinglage par entrée.** Activer le vocabulaire prend effet **immédiatement**, y compris sur les PR déjà ouvertes (élargissant, §8.1.3) ; l'éteindre ne dégrade **aucune** PR déjà ouverte (restrictif, épinglé), et les `done:` écrits avant l'extinction y restent conformes. Une PR épinglée **avant** la version qui livre la famille reçoit les entrées désactivées par le vivant, sans migration, et conserve son empreinte.
...
| Q4 | Trois labels de réponse suffisent-ils, ou « accepté, action à venir » mérite-t-il le sien ? | Calibrage (§3.2). L'ordre des essais est dicté par le §8.1.3 : **ajouter** un label est élargissant, donc en direct et sans migration ; en **retirer** un est restrictif et épinglé. Commencer petit est le sens réversible. | après P4 |
