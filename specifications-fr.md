...
**2. Les deux composants ne lisent pas au même instant.** Ils résolvent la même configuration, aux mêmes sources (§8.1.2), mais leurs caches expirent séparément : une modification met un temps borné à se propager de chaque côté, et l'extension peut juger avec une configuration que le vérificateur n'a pas encore lue, ou l'inverse.
